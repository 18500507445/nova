...
class NumberUtilsTest {
    ...
    public void test1() {
        ...
        System.err.println(str + "isDigits结果:" + NumberUtils.isDigits(str));
        // isParsable可以判断是不是整数、浮点数,不能识别正负,都是当做10进制来处理的
        System.err.println(str + "isParsable结果:" + NumberUtils.isParsable(str));
        // isCreatable可以判断是不是整数、浮点数,识别正负号，以及进制
        System.err.println(str + "isCreatable结果:" + NumberUtils.isCreatable(str));
        str = "12.3";
        System.err.println(str + "isDigits结果:" + NumberUtils.isDigits(str));
        System.err.println(str + "isParsable结果:" + NumberUtils.isParsable(str));
        System.err.println(str + "isCreatable结果:" + NumberUtils.isCreatable(str));
