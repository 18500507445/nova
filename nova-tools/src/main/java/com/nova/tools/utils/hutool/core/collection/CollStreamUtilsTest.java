...
public class CollStreamUtilsTest {
    ...
    public void testToIdentityMap() {
        ...
        Assert.equals(map, Collections.EMPTY_MAP);
        ...
        map = CollStreamUtil.toIdentityMap(list, Student::getStudentId);
        Assert.equals(map.get(1L).getName(), "张三");
        Assert.equals(map.get(2L).getName(), "李四");
        Assert.equals(map.get(3L).getName(), "王五");
        Assert.isNull(map.get(4L));
    ...
    public void testToMap() {
        ...
        list.add(new Student(1, 1, 3, "王五"));
        map = CollStreamUtil.toMap(list, Student::getStudentId, Student::getName);
        Assert.equals(map.get(1L), "张三");
        Assert.equals(map.get(2L), "李四");
        Assert.equals(map.get(3L), "王五");
        Assert.isNull(map.get(4L));
    ...
    public void testGroup2Map() {
        ...
        Assert.equals(termIdClassIdStudentCompareMap, termIdClassIdStudentMap);
    }
    ...
    public void testGroupBy() {
        ...
        Assert.equals("李四", longOptionalMap.get(1L).get().getName());
        ...
        Assert.equals(termIdStudentsCompareMap, termIdStudentsMap);
        ...
        Assert.equals(termIdCountCompareMap, termIdCountMap);
    }
    ...
    public void testTranslate2List() {
        ...
        Assert.equals(list, Collections.EMPTY_LIST);
