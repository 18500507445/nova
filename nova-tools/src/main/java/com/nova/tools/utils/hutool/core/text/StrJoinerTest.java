...
public class StrJoinerTest {
    ...
    public void joinIntArrayTest() {
        ...
        Assert.equals("1,2,3,4,5", append.toString());
    }
    ...
    public void joinMultiArrayTest() {
        ...
        Assert.equals("1,2,3,4", append.toString());
    }
    ...
    public void joinNullModeTest() {
        StrJoiner append = StrJoiner.of(",")
                ...
                .append((Object) null)
                .append("3");
        Assert.equals("1,3", append.toString());
        ...
        append = StrJoiner.of(",")
                ...
                .append((Object) null)
                .append("3");
        Assert.equals("1,null,3", append.toString());
    }
    ...
    public void joinWrapTest() {
        StrJoiner append = StrJoiner.of(",", "[", "]")
                ...
                .append("2")
                .append("3");
        Assert.equals("[1,2,3]", append.toString());
    ...
    public void lengthTest() {
        ...
        Assert.equals(joiner.toString().length(), joiner.length());
    ...
    public void mergeTest() {
        ...
        Assert.equals("[123,456,789]", merge.toString());
    }
}
