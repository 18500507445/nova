...
public class OptTest {
    ...
    public void peeksTest() {
        ...
        Opt.of(user).peeks(
                u -> Assert.equals("hutool", u.getNickname()),
                u -> Assert.equals("hutool", u.getUsername())
        );
        Assert.equals("hutool", user.getNickname());
        Assert.equals("hutool", user.getUsername());
    ...
    public void orElseThrowTest3() {
        ...
        Assert.isNull(exceptionWithMessage);
    }
...
//		Opt.ofNullable(userList).map(List::stream).flatMap(Stream::findFirst);
        ...
        Assert.isNull(user.getUsername());
        Assert.isNull(user.getNickname());
    }
    ...
    public void ofEmptyAbleTest() {
        ...
        Assert.equals(past, hutool);
        Assert.equals(hutool, Collections.singletonList("hutool"));
    }
    ...
    public void execTest() {
        ...
        Assert.equals(npe, npeSituation);
        Assert.equals(indexOut, indexOutSituation);
        Assert.equals("hutool", npe);
        Assert.equals("hutool", indexOut);
