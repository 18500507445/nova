...
public class randomTest {
    ...
    public static BigDecimal getRandomMoney(RedPackage _redPackage) {
        ...
        if (_redPackage.remainSize == 1) {
            ...
            return _redPackage.remainMoney.setScale(2, RoundingMode.DOWN);
        }

        BigDecimal random = BigDecimal.valueOf(Math.random());
        BigDecimal min = BigDecimal.valueOf(0.01);

        BigDecimal halfRemainSize = BigDecimal.valueOf(_redPackage.remainSize).divide(new BigDecimal(2), RoundingMode.UP);
        BigDecimal max1 = _redPackage.remainMoney.divide(halfRemainSize, RoundingMode.DOWN);
        BigDecimal minRemainAmount = min.multiply(BigDecimal.valueOf(_redPackage.remainSize - 1)).setScale(2, RoundingMode.DOWN);
        ...
        _redPackage.remainSize--;
        _redPackage.remainMoney = _redPackage.remainMoney.subtract(money).setScale(2, RoundingMode.DOWN);
        return money;
    }
