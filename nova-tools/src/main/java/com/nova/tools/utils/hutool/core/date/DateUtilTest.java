...
public class DateUtilTest {
    ...
    public void formatAndParseCustomTest() {
        ...
        Assert.equals("1488297600", format);

        final DateTime parse = DateUtil.parse(format, "#sss");
        Assert.equals(date, parse);
    }
    ...
    public void formatAndParseCustomTest2() {
        ...
        final String format = DateUtil.format(date, "#SSS");
        Assert.equals("1488297600000", format);
    ...
    public void beginAndEndTest() {
        ...
        Assert.equals("2017-03-01 00:00:00", beginOfDay.toString());
        // 一天的结束
        final Date endOfDay = DateUtil.endOfDay(date);
        Assert.equals("2017-03-01 23:59:59", endOfDay.toString());
    }

    @Test
    public void endOfDayTest() {
        final DateTime parse = DateUtil.parse("2020-05-31 00:00:00");
        Assert.equals("2020-05-31 23:59:59", DateUtil.endOfDay(parse).toString());
    }
    ...
    public void truncateTest() {
        ...
        Assert.equals("2020-02-29 12:59:00", dateTime.toString());
    }
    ...
    public void ceilingMinuteTest() {
        ...
        Assert.equals("2020-02-29 12:59:59.999", dateTime.toString(DatePattern.NORM_DATETIME_MS_PATTERN));

        dateTime = DateUtil.ceiling(date2, DateField.MINUTE, true);
        Assert.equals("2020-02-29 12:59:59.000", dateTime.toString(DatePattern.NORM_DATETIME_MS_PATTERN));
    }
    ...
    public void ceilingDayTest() {
        ...
        Assert.equals("2020-02-29 23:59:59.999", dateTime.toString(DatePattern.NORM_DATETIME_MS_PATTERN));

        dateTime = DateUtil.ceiling(date2, DateField.DAY_OF_MONTH, true);
        Assert.equals("2020-02-29 23:59:59.000", dateTime.toString(DatePattern.NORM_DATETIME_MS_PATTERN));
    }
    ...
    public void beginOfWeekTest() {
        ...
        Assert.equals("2017-02-27 00:00:00", beginOfWeek.toString());
        // 一周的结束
        final Date endOfWeek = DateUtil.endOfWeek(date);
        Assert.equals("2017-03-05 23:59:59", endOfWeek.toString());

        final Calendar calendar = DateUtil.calendar(date);
        // 一周的开始
        final Calendar begin = DateUtil.beginOfWeek(calendar);
        Assert.equals("2017-02-27 00:00:00", DateUtil.date(begin).toString());
        // 一周的结束
        final Calendar end = DateUtil.endOfWeek(calendar);
        Assert.equals("2017-03-05 23:59:59", DateUtil.date(end).toString());
    }
    ...
    public void beginOfWeekTest2() {
        ...
        Assert.equals("2020-03-08 00:00:00", DateUtil.date(begin).toString());

        final Calendar calendar2 = date.toCalendar();
        final Calendar end = DateUtil.endOfWeek(calendar2, false);
        Assert.equals("2020-03-14 23:59:59", DateUtil.date(end).toString());
    }
    ...
    public void offsetDateTest() {
        ...
        Assert.equals("2017-03-03 22:33:23", newDate.toString());

        // 偏移天
        final DateTime newDate2 = DateUtil.offsetDay(date, 3);
        Assert.equals("2017-03-04 22:33:23", newDate2.toString());

        // 偏移小时
        final DateTime newDate3 = DateUtil.offsetHour(date, -3);
        Assert.equals("2017-03-01 19:33:23", newDate3.toString());

        // 偏移月
        final DateTime offsetMonth = DateUtil.offsetMonth(date, -1);
        Assert.equals("2017-02-01 22:33:23", offsetMonth.toString());
    }
    ...
    public void offsetMonthTest() {
        ...
        Assert.equals("2018-05-31 00:00:00", list.get(0).toString());
        Assert.equals("2018-06-30 00:00:00", list.get(1).toString());
        Assert.equals("2018-07-31 00:00:00", list.get(2).toString());
        Assert.equals("2018-08-31 00:00:00", list.get(3).toString());
    }
    ...
    public void betweenTest() {
        ...
        Assert.equals(1, betweenMonth);// 相差一个月
        // 反向
        ...
        Assert.equals(31, betweenDay);// 相差一个月，31天
        // 反向
        ...
        Assert.equals(44721, betweenMinute);
        // 反向
        ...
        Assert.equals(2683311, betweenSecond);
        // 反向
        ...
        Assert.equals(2683311000L, betweenMS);
        // 反向
    ...
    public void formatChineseDateTest() {
        ...
        Assert.equals("二〇一八年二月二十四日", formatChineseDate);

        formatChineseDate = DateUtil.formatChineseDate(DateUtil.parse("2018-02-14"), true, false);
        Assert.equals("二〇一八年二月十四日", formatChineseDate);
    }
    ...
    public void formatChineseDateTimeTest() {
        ...
        Assert.equals("二〇一八年二月二十四日十二时十三分十四秒", formatChineseDateTime);

        formatChineseDateTime = DateUtil.formatChineseDate(DateUtil.parse("2022-01-18 12:00:00"), true, true);
        Assert.equals("二〇二二年一月十八日十二时零分零秒", formatChineseDateTime);
    }
    ...
    public void formatBetweenTest() {
        ...
        Assert.equals("31天1小时21分", formatBetween);
    }
    ...
    public void secondToTimeTest() {
        ...
        Assert.equals("01:00:00", time);
        time = DateUtil.secondToTime(3800);
        Assert.equals("01:03:20", time);
        time = DateUtil.secondToTime(0);
        Assert.equals("00:00:00", time);
        time = DateUtil.secondToTime(30);
        Assert.equals("00:00:30", time);
    }
    ...
    public void parseTest6() {
        ...
        Assert.equals("2019-06-04 16:25:15", dateTime.toString());
    }
    ...
    public void parseTest7() {
        ...
        assert dateTime != null;
        Assert.equals("2019-06-01 19:45:43", dateTime.toString());
    ...
    public void parseTest8() {
        ...
        final DateTime dateTime = DateUtil.parse(str);
        assert dateTime != null;
        Assert.equals("2020-06-28 02:14:13", dateTime.toString());
    }
    ...
    public void parseNormFullTest() {
        ...
        Assert.equals("2020-02-06 01:58:00.000", dateTime.toString(DatePattern.NORM_DATETIME_MS_PATTERN));
        ...
        dateTime = DateUtil.parse(str);
        Assert.notNull(dateTime);
        Assert.equals("2020-02-06 01:58:00.111", dateTime.toString(DatePattern.NORM_DATETIME_MS_PATTERN));
    ...
    public void parseAndOffsetTest() {
        ...
        final DateTime dateTime = DateUtil.parse(str);
        assert dateTime != null;
        Assert.equals("2019-09-17 13:26:17", dateTime.toString());

        final DateTime offset = DateUtil.offsetHour(dateTime, 8);
        Assert.equals("2019-09-17 21:26:17", offset.toString());
    }
    ...
    public void parseDateTest() {
        ...
        Assert.equals("2018-04-10", format);
    }
    ...
    public void parseToDateTimeTest1() {
        ...
        Assert.equals(dt2, dt3);
        Assert.equals(dt3, dt4);
    }
    ...
    public void parseUTCTest() {
        ...
        Assert.equals("2018-09-13 05:34:31", dateStr);

        // 使用当前（上海）时区
        dateStr = dt.toString(TimeZone.getTimeZone("GMT+8:00"));
        Assert.equals("2018-09-13 13:34:31", dateStr);

        dateStr1 = "2018-09-13T13:34:32+0800";
        dt = DateUtil.parseUTC(dateStr1);
        dateStr = dt.toString(TimeZone.getTimeZone("GMT+8:00"));
        Assert.equals("2018-09-13 13:34:32", dateStr);

        dateStr1 = "2018-09-13T13:34:33+08:00";
        dt = DateUtil.parseUTC(dateStr1);
        dateStr = dt.toString(TimeZone.getTimeZone("GMT+8:00"));
        Assert.equals("2018-09-13 13:34:33", dateStr);

        dateStr1 = "2018-09-13T13:34:34+0800";
        dt = DateUtil.parse(dateStr1);
        assert dt != null;
        dateStr = dt.toString(TimeZone.getTimeZone("GMT+8:00"));
        Assert.equals("2018-09-13 13:34:34", dateStr);

        dateStr1 = "2018-09-13T13:34:35+08:00";
        dt = DateUtil.parse(dateStr1);
        assert dt != null;
        dateStr = dt.toString(TimeZone.getTimeZone("GMT+8:00"));
        Assert.equals("2018-09-13 13:34:35", dateStr);
        ...
        Assert.equals("2018-09-13 13:34:36.999", dateStr);

        dateStr1 = "2018-09-13T13:34:37.999+08:00";
        dt = DateUtil.parseUTC(dateStr1);
        dateStr = dt.toString(simpleDateFormat);
        Assert.equals("2018-09-13 13:34:37.999", dateStr);

        dateStr1 = "2018-09-13T13:34:38.999+0800";
        dt = DateUtil.parse(dateStr1);
        assert dt != null;
        dateStr = dt.toString(simpleDateFormat);
        Assert.equals("2018-09-13 13:34:38.999", dateStr);

        dateStr1 = "2018-09-13T13:34:39.999+08:00";
        dt = DateUtil.parse(dateStr1);
        assert dt != null;
        dateStr = dt.toString(simpleDateFormat);
        Assert.equals("2018-09-13 13:34:39.999", dateStr);
        ...
        assert dt != null;
        dateStr = dt.toString();
        Assert.equals("2018-09-13 13:34:39", dateStr);
    }
    ...
    public void parseUTCTest2() {
        ...
        Assert.equals("2021-03-30 12:56:51", parse.toString());
    ...
    public void parseUTCTest3() {
        ...
        Assert.notNull(dateTime);
        Assert.equals("2022-08-13 09:30:00", dateTime.toString());
    }
    ...
    public void parseJDkTest() {
        ...
        Assert.equals("2019-05-16 17:57:18", Objects.requireNonNull(time).toString());
    }
    ...
    public void parseISOTest() {
        ...
        final DateTime time = DateUtil.parse(dateStr);
        Assert.equals("2020-04-23 02:31:00", Objects.requireNonNull(time).toString());
    }
    ...
    public void endOfYearTest() {
        ...
        Assert.equals("2019-12-31 23:59:59", endOfYear.toString());
    }
    ...
    public void endOfQuarterTest() {
        ...
        Assert.equals("2020-06-30 23:59:59", DateUtil.format(date, "yyyy-MM-dd HH:mm:ss"));
    }
    ...
    public void compareTest() {
        ...
        Assert.equals(1, DateUtil.compare(date1, date2));
        Assert.equals(1, DateUtil.compare(date1, date2, DatePattern.NORM_DATETIME_PATTERN));
        Assert.equals(0, DateUtil.compare(date1, date2, DatePattern.NORM_DATE_PATTERN));
        Assert.equals(0, DateUtil.compare(date1, date2, DatePattern.NORM_DATETIME_MINUTE_PATTERN));


        final Date date11 = DateUtil.parse("2021-04-13 23:59:59.999");
        final Date date22 = DateUtil.parse("2021-04-11 23:10:10");
        Assert.equals(0, DateUtil.compare(date11, date22, DatePattern.NORM_MONTH_PATTERN));
    }

    @Test
    public void yearAndQTest() {
        final String yearAndQuarter = DateUtil.yearAndQuarter(DateUtil.parse("2018-12-01"));
        Assert.equals("20184", yearAndQuarter);
        ...
        Assert.equals("20183", list.get(0));
        Assert.equals("20184", list.get(1));
    ...
    public void toInstantTest() {
        ...
        Assert.equals("2017-05-06T00:30:00Z", instant.toString());
    ...
    public void dateTest() {
        ...
        Assert.equals("2017-05-06 08:30:00", date.toString());

        //LocalDate ==> date
        final LocalDate localDate = localDateTime.toLocalDate();
        final DateTime date2 = DateUtil.date(localDate);
        Assert.equals("2017-05-06",
    ...
    public void dateTest2() {
        ...
        Assert.equals("1969-12-15 00:00:00", date.toString());
    }
    ...
    public void localDateTimeTest() {
        ...
        Assert.equals(strDate, strDate1);
    ...
    public void localDateTimeTest2() {
        ...
        Assert.equals(strDate, DateUtil.format(localDateTime, DatePattern.NORM_DATE_PATTERN));
    }
    ...
    public void betweenDayTest() {
        for (int i = 0; i < 1000; i++) {
            ...
            Assert.equals(Math.abs(LocalDate.parse(datr).toEpochDay()), betweenDay);
        }
    }
    ...
    public void dayOfYearTest() {
        ...
        Assert.equals(1, dayOfYear);
        final int lengthOfYear = DateUtil.lengthOfYear(2020);
        Assert.equals(366, lengthOfYear);
    }
    ...
    public void parseSingleNumberTest() {
        ...
        Assert.equals("2020-05-08 00:00:00", dateTime.toString());
        ...
        Assert.equals("2020-05-08 03:12:03", dateTime.toString());
        dateTime = DateUtil.parse("2020-5-8 3:2:3");
        Assert.equals("2020-05-08 03:02:03", dateTime.toString());
        dateTime = DateUtil.parse("2020-5-8 3:12:13");
        Assert.equals("2020-05-08 03:12:13", dateTime.toString());

        dateTime = DateUtil.parse("2020-5-8 4:12:26.223");
        Assert.equals("2020-05-08 04:12:26", dateTime.toString());
    }
    ...
    public void parseISO8601Test() {
        ...
        Assert.equals("2020-06-03 12:32:12", parse.toString());
    }
    ...
    public void formatTest() {
        ...
        Assert.equals("2021-07-14 23:59:59", DateUtil.format(date, DatePattern.NORM_DATETIME_FORMATTER));
        Assert.equals("2021-07-14 23:59:59", DateUtil.format(date, DatePattern.NORM_DATETIME_FORMAT));
        Assert.equals("2021-07-14 23:59:59", DateUtil.format(date, DatePattern.NORM_DATETIME_PATTERN));
    }
    ...
    public void formatNormDateTimeFormatterTest() {
        ...
        Assert.equals("2021-07-14 10:05:38", format);
    ...
    public void isWeekendTest() {
        ...
        Assert.isFalse(DateUtil.isWeekend(parse));

        parse = DateUtil.parse("2021-07-25");
        Assert.isTrue(DateUtil.isWeekend(parse));
    ...
    public void isOverlapTest() {
        ...
        Assert.isFalse(DateUtil.isOverlap(oneStartTime, oneEndTime, realStartTime, realEndTime));
        Assert.isFalse(DateUtil.isOverlap(oneStartTime2, oneEndTime2, realStartTime, realEndTime));
        Assert.isTrue(DateUtil.isOverlap(oneStartTime3, oneEndTime3, realStartTime, realEndTime));

        Assert.isFalse(DateUtil.isOverlap(realStartTime1, realEndTime1, startTime, endTime));
        Assert.isFalse(DateUtil.isOverlap(startTime, endTime, realStartTime1, realEndTime1));
    }
    ...
    public void isOverlapTest2() {
        ...
        Assert.isTrue(DateUtil.isOverlap(oneStartTime, oneEndTime, oneStartTime2, oneEndTime2));
    }
    ...
    public void isLastDayTest() {
        ...
        //Assert.equals(dayOfMonth,dateTime.dayOfMonth());
        //Assert.isTrue("not is last day of this month !!",DateUtil.isLastDayOfMonth(dateTime));
    }
}
