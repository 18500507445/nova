...
public class JSONConvertTest {
    ...
    public void testBean2Json() {
        ...
        Assert.equals(new Integer(1), obj.getInt("toSendManIdCard"));

        JSONObject examInfoDictsJson = obj.getJSONObject("userInfoDict");
        Assert.equals(new Integer(1), examInfoDictsJson.getInt("id"));
        Assert.equals("质量过关", examInfoDictsJson.getStr("realName"));
    ...
    public void testJson2Bean() {
        ...
        Assert.equals(userInfoDict.getId(), new Integer(1));
        Assert.equals(userInfoDict.getRealName(), "质量过关");
        ...
        Assert.isNull(userInfoDict2.getId());
    }
    ...
    public void testJson2Bean2() {
        ...
        Assert.equals(obj.getStr("HA001"), vo.getHA001());
        Assert.equals(obj.getInt("costTotal"), vo.getCostTotal());
    }
}