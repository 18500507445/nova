...
public class HttpUtilTest {
    ...
    public void isHttpTest() {
        Assert.isTrue(HttpUtil.isHttp("Http://aaa.bbb"));
        Assert.isTrue(HttpUtil.isHttp("HTTP://aaa.bbb"));
        Assert.isFalse(HttpUtil.isHttp("FTP://aaa.bbb"));
    }

    @Test
    public void isHttpsTest() {
        Assert.isTrue(HttpUtil.isHttps("Https://aaa.bbb"));
        Assert.isTrue(HttpUtil.isHttps("HTTPS://aaa.bbb"));
        Assert.isTrue(HttpUtil.isHttps("https://aaa.bbb"));
        Assert.isFalse(HttpUtil.isHttps("ftp://aaa.bbb"));
    }
    ...
    public void decodeParamsTest() {
        ...
        Assert.equals("0", map.get("uuuu").get(0));
        Assert.equals("b", map.get("a").get(0));
        Assert.equals("?#@!$%^&=dsssss555555", map.get("c").get(0));
    }
    ...
    public void decodeParamMapTest() {
        ...
        Assert.equals("123", paramMap.get("aa"));
        Assert.equals("NzBkMjQxNDM1MDVlMDliZTk1OTU3ZDI1OTI0NTBiOWQ=", paramMap.get("f_token"));
    }
    ...
    public void toParamsTest() {
        ...
        Assert.equals(paramsStr, encodedParams);
    }
    ...
    public void encodeParamTest() {
        ...
        encode = HttpUtil.encodeParams(paramsStr, CharsetUtil.CHARSET_UTF_8);
        Assert.equals("a=bbb&c=%E4%BD%A0%E5%A5%BD&%E5%93%88%E5%96%BD=", encode);

        // URL原样输出
        paramsStr = "https://www.hutool.cn/";
        encode = HttpUtil.encodeParams(paramsStr, CharsetUtil.CHARSET_UTF_8);
        Assert.equals(paramsStr, encode);

        // URL原样输出
        paramsStr = "https://www.hutool.cn/?";
        encode = HttpUtil.encodeParams(paramsStr, CharsetUtil.CHARSET_UTF_8);
        Assert.equals("https://www.hutool.cn/", encode);
    }
    ...
    public void decodeParamTest() {
        ...
        Assert.equals("b", map.get("a").get(0));
        Assert.equals("d", map.get("c").get(0));
        ...
        Assert.equals("b", map.get("a").get(0));
        Assert.equals("d", map.get("c").get(0));
        Assert.isNull(map.get("e").get(0));
        Assert.isNull(map.get("").get(0));

        // 被编码的键和值被还原
        a = "a=bbb&c=%E4%BD%A0%E5%A5%BD&%E5%93%88%E5%96%BD=";
        map = HttpUtil.decodeParams(a, CharsetUtil.UTF_8);
        Assert.equals("bbb", map.get("a").get(0));
        Assert.equals("你好", map.get("c").get(0));
        Assert.equals("", map.get("哈喽").get(0));
    }
    ...
    public void getCharsetTest() {
        ...
        Assert.equals("UTF-8", charsetName);
