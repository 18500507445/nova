package com.nova.cache.limit.utils;

import cn.hutool.core.util.SerializeUtil;
import cn.hutool.core.util.StrUtil;
import com.nova.cache.limit.config.BloomFilterHelper;
...
public class JedisUtil {
     ...
     * @param value             值
     */
    public void add(BloomFilterHelper bloomFilterHelper, String key, Object value) {
        try (Jedis jedis = this.jedisPool.getResource()) {
     ...
     * @return 是否存在
     */
    public boolean contains(BloomFilterHelper bloomFilterHelper, String key, Object value) {
        try (Jedis jedis = this.jedisPool.getResource()) {
            int[] offset = bloomFilterHelper.murmurHashOffset(value);
            for (int i : offset) {
                Boolean flag = jedis.getbit(key, i);
