...
//		Assert.equals("五千万零八千", f1);
	...
	public void digitToChineseTest() {
		...
		Assert.equals("壹拾贰万肆仟壹佰贰拾肆亿壹仟贰佰肆拾壹万贰仟肆佰贰拾壹元壹角贰分", digitToChinese);

		digitToChinese = Convert.digitToChinese(12_0000_1241_2421L);
		Assert.equals("壹拾贰万亿零壹仟贰佰肆拾壹万贰仟肆佰贰拾壹元整", digitToChinese);

		digitToChinese = Convert.digitToChinese(12_0000_0000_2421L);
		Assert.equals("壹拾贰万亿零贰仟肆佰贰拾壹元整", digitToChinese);

		digitToChinese = Convert.digitToChinese(12_4124_1241_2421D);
		Assert.equals("壹拾贰万肆仟壹佰贰拾肆亿壹仟贰佰肆拾壹万贰仟肆佰贰拾壹元整", digitToChinese);

		digitToChinese = Convert.digitToChinese(2421.02);
		Assert.equals("贰仟肆佰贰拾壹元零贰分", digitToChinese);
	}
	...
	public void digitToChineseTest2() {
		...
		Assert.equals("陆万柒仟伍佰伍拾陆元叁角贰分", digitUppercase);

		a = 1024.00;
		digitUppercase = Convert.digitToChinese(a);
		Assert.equals("壹仟零贰拾肆元整", digitUppercase);
	...
	public void chineseToNumberTest(){
		Assert.equals(0, NumberChineseFormatter.chineseToNumber("零"));
		Assert.equals(102, NumberChineseFormatter.chineseToNumber("一百零二"));
		Assert.equals(112, NumberChineseFormatter.chineseToNumber("一百一十二"));
		Assert.equals(1012, NumberChineseFormatter.chineseToNumber("一千零一十二"));
		Assert.equals(1000000, NumberChineseFormatter.chineseToNumber("一百万"));
		Assert.equals(2000100112, NumberChineseFormatter.chineseToNumber("二十亿零一十万零一百一十二"));
	}

	@Test
	public void chineseToNumberTest2(){
		Assert.equals(120, NumberChineseFormatter.chineseToNumber("一百二"));
		Assert.equals(1200, NumberChineseFormatter.chineseToNumber("一千二"));
		Assert.equals(22000, NumberChineseFormatter.chineseToNumber("两万二"));
		Assert.equals(22003, NumberChineseFormatter.chineseToNumber("两万二零三"));
		Assert.equals(22010, NumberChineseFormatter.chineseToNumber("两万二零一十"));
	}
	...
	public void chineseToNumberTest3(){
		...
		// 十二 -> 一十二
		// 百二 -> 一百二
		Assert.equals(12, NumberChineseFormatter.chineseToNumber("十二"));
		Assert.equals(120, NumberChineseFormatter.chineseToNumber("百二"));
		Assert.equals(1300, NumberChineseFormatter.chineseToNumber("千三"));
	}
