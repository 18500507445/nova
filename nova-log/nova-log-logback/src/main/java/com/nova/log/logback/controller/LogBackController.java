...
public class LogBackController extends BaseController {
    ...
    public ResResult<Void> traceTest(HttpServletRequest req) {
    ...
    public ResResult<Void> traceTest1(HttpServletRequest req) {
        String traceId = req.getHeader(Trace.TRACE_ID);
    ...
    public ResResult<Void> dynamicLog(@RequestParam String logLevel) {
