...
public class SM2Test {
    ...
    public void generateKeyPairTest() {
        ...
        Assert.notNull(pair.getPrivate());
        Assert.notNull(pair.getPublic());
    }
    ...
    public void KeyPairOIDTest() {
        ...
        KeyPair pair = SecureUtil.generateKeyPair("SM2");
        Assert.isTrue(HexUtil.encodeHexStr(pair.getPrivate().getEncoded()).toUpperCase().contains(OID));
        Assert.isTrue(HexUtil.encodeHexStr(pair.getPublic().getEncoded()).toUpperCase().contains(OID));
    }
    ...
    public void sm2CustomKeyTest() {
        ...
        Assert.equals("我是一段测试aaaa", StrUtil.str(decrypt, CharsetUtil.CHARSET_UTF_8));
    }
    ...
    public void sm2Test() {
        ...
        // 获取私钥和公钥
        Assert.notNull(sm2.getPrivateKey());
        Assert.notNull(sm2.getPrivateKeyBase64());
        Assert.notNull(sm2.getPublicKey());
        Assert.notNull(sm2.getPrivateKeyBase64());
    ...
    public void sm2Base64Test() {
        ...
        Assert.equals(text.toString(), decryptStr);
        ...
        Assert.equals(text.toString(), decryptStr2);
    }
    ...
    public void sm2PublicKeyEncodeDecodeTest() {
        ...
        Assert.equals(HexUtil.encodeHexStr(publicKey.getEncoded()), HexUtil.encodeHexStr(Hexdecode.getEncoded()));
        Assert.equals(HexUtil.encodeHexStr(publicKey.getEncoded()), HexUtil.encodeHexStr(B64decode.getEncoded()));
    }
    ...
    public void sm2WithPointTest() {
        ...
        Assert.isTrue(sm2.verifyHex(data, sign));
    }
    ...
    public void sm2PlainWithPointTest() {
        ...
        Assert.isTrue(sm2.verifyHex(data, sign2));
    }
    ...
    public void encryptAndSignTest() {
        ...
        Assert.isTrue(sm2.verify(src.getBytes(StandardCharsets.UTF_8), sign));

        byte[] dec = sm2.decrypt(data, KeyType.PrivateKey);
        Assert.equals(dec, src.getBytes(StandardCharsets.UTF_8));
    }
    ...
    public void dLengthTest() {
        final SM2 sm2 = SmUtil.sm2();
        Assert.equals(64, sm2.getDHex().length());
        Assert.equals(32, sm2.getD().length);

        // 04占位一个字节
        Assert.equals(65, sm2.getQ(false).length);
    }
}
