...
public class AliasLinkAnnotationPostProcessorTest {
	...
	public void processForceAliasForTest() {
		...
		Assert.equals(ReflectUtil.getMethod(AnnotationForTest.class, "value"), valueAttribute.getAttribute());
		Assert.isFalse(valueAttribute.isWrapped());
		Assert.equals(CacheableAnnotationAttribute.class, valueAttribute.getClass());

		AnnotationAttribute nameAttribute = synthesizedAnnotation.getAttributes().get("name");
		Assert.equals(ReflectUtil.getMethod(AnnotationForTest.class, "name"), nameAttribute.getAttribute());
		Assert.isTrue(nameAttribute.isWrapped());
		Assert.equals(ForceAliasedAnnotationAttribute.class, nameAttribute.getClass());

		Assert.equals(valueAttribute, ((WrappedAnnotationAttribute)nameAttribute).getLinked());
	}
	...
	public void processAliasForTest() {
		...
		Assert.equals(ReflectUtil.getMethod(AnnotationForTest.class, "value2"), valueAttribute.getAttribute());
		Assert.isFalse(valueAttribute.isWrapped());
		Assert.equals(CacheableAnnotationAttribute.class, valueAttribute.getClass());

		AnnotationAttribute nameAttribute = synthesizedAnnotation.getAttributes().get("name2");
		Assert.equals(ReflectUtil.getMethod(AnnotationForTest.class, "name2"), nameAttribute.getAttribute());
		Assert.isTrue(nameAttribute.isWrapped());
		Assert.equals(AliasedAnnotationAttribute.class, nameAttribute.getClass());
