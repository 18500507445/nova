...
public class GooglePayment {
     ...
     * 代理IP
     */
    public static final String HOST_NAME = "172.30.16.72";

    /**
     * 端口
     */
    public static final String PORT = "2022";
    ...
    public Map<String, String> getAccessToken(String clientId, String clientSecret, String token, String type) {
        ...
        try {
            ...
            String response = HttpUtil.createGet(url).addHeaders(headers).formStr(params).execute().body();
