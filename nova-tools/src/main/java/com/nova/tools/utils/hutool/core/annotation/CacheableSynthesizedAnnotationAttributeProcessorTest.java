...
public class CacheableSynthesizedAnnotationAttributeProcessorTest {
	...
	public void getAttributeValueTest() {
		...
		Assert.equals("name2", processor.getAttributeValue("name", String.class, Arrays.asList(annotation1, annotation2)));
		Assert.equals(Integer.valueOf(111), processor.getAttributeValue("value", Integer.class, Arrays.asList(annotation1, annotation2)));
	}
