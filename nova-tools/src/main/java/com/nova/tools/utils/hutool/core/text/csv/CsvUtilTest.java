...
public class CsvUtilTest {
    ...
    public void readTest() {
        ...
        Assert.equals("sss,sss", row0.get(0));
        Assert.equals("姓名", row0.get(1));
        Assert.equals("性别", row0.get(2));
        Assert.equals("关注\"对象\"", row0.get(3));
        Assert.equals("年龄", row0.get(4));
        Assert.equals("", row0.get(5));
        Assert.equals("\"", row0.get(6));
    }
    ...
    public void readTest2() {
        ...
        reader.read(FileUtil.getUtf8Reader("test.csv"), (csvRow) -> {
            // 只有一行，所以直接判断
            Assert.equals("sss,sss", csvRow.get(0));
            Assert.equals("姓名", csvRow.get(1));
            Assert.equals("性别", csvRow.get(2));
            Assert.equals("关注\"对象\"", csvRow.get(3));
            Assert.equals("年龄", csvRow.get(4));
            Assert.equals("", csvRow.get(5));
            Assert.equals("\"", csvRow.get(6));
        });
    }
