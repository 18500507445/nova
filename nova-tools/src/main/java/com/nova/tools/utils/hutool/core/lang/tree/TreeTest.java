...
public class TreeTest {
    ...
    public void sampleTreeTest() {
        ...
        for (Tree<String> tree : treeList) {
            Assert.notNull(tree);
            Assert.equals("0", tree.getParentId());
//			Console.log(tree);
        }
        ...
        Assert.equals(rootNode0, parent);
    }
    ...
    public void treeTest() {
        ...
        Assert.equals(treeNodes.size(), 2);
    }
