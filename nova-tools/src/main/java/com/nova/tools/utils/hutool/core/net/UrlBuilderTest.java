...
public class UrlBuilderTest {
    ...
    public void buildTest() {
        ...
        Assert.equals("http://www.hutool.cn/", buildUrl);
        Assert.equals(buildUrl, 80, String.valueOf(builder.getPortWithDefault()));
    }
    ...
    public void buildWithoutSlashTest() {
        ...
        Assert.equals("http://192.168.1.1:8080", buildUrl);
        ...
        Assert.equals("http://192.168.1.1:8080?url=http://192.168.1.1/test/1", buildUrl);
        Assert.equals(buildUrl, 8080, String.valueOf(urlBuilder.getPortWithDefault()));
    }
    ...
    public void buildTest2() {
        ...
        Assert.equals("http://www.hutool.cn/+8618888888888", buildUrl);
    }
    ...
    public void testHost() {
        ...
        Assert.equals("https://www.hutool.cn/", buildUrl);
    }
    ...
    public void testHostPort() {
        final String buildUrl = UrlBuilder.of()
                ...
                .setPort(8080)
                .build();
        Assert.equals("https://www.hutool.cn:8080/", buildUrl);
    }
    ...
    public void testPathAndQuery() {
        ...
        Assert.equals("https://www.hutool.cn/aaa/bbb?ie=UTF-8&wd=test", buildUrl);
    }
    ...
    public void testQueryWithChinese() {
        ...
        Assert.equals("https://www.hutool.cn/aaa/bbb?ie=UTF-8&wd=%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testMultiQueryWithChinese() {
        ...
        Assert.equals("https://www.hutool.cn/s?ie=UTF-8&ie=GBK&wd=%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testFragment() {
        ...
        Assert.equals("https://www.hutool.cn/#abc", buildUrl);
    }
    ...
    public void testChineseFragment() {
        ...
        Assert.equals("https://www.hutool.cn/#%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testChineseFragmentWithPath() {
        final String buildUrl = new UrlBuilder()
                ...
                .addPath("/s")
                .setFragment("测试").build();
        Assert.equals("https://www.hutool.cn/s#%E6%B5%8B%E8%AF%95", buildUrl);
    }
    ...
    public void testChineseFragmentWithPathAndQuery() {
        final String buildUrl = new UrlBuilder()
                ...
                .addQuery("wd", "test")
                .setFragment("测试").build();
        Assert.equals("https://www.hutool.cn/s?wd=test#%E6%B5%8B%E8%AF%95", buildUrl);
    }

    @Test
    public void ofTest() {
        final UrlBuilder builder = UrlBuilder.of("http://www.hutool.cn/aaa/bbb/?a=1&b=2#frag1", CharsetUtil.CHARSET_UTF_8);
        Assert.equals("http", builder.getScheme());
        Assert.equals("www.hutool.cn", builder.getHost());

        Assert.equals("aaa", builder.getPath().getSegment(0));
        Assert.equals("bbb", builder.getPath().getSegment(1));

        Assert.equals("1", builder.getQuery().get("a"));
        Assert.equals("2", builder.getQuery().get("b"));

        Assert.equals("frag1", builder.getFragment());
    }

    @Test
    public void ofNullQueryTest() {
        final UrlBuilder builder = UrlBuilder.of("http://www.hutool.cn/aaa/bbb", CharsetUtil.CHARSET_UTF_8);
        Assert.notNull(builder.getQuery());
        Assert.isNull(builder.getQuery().get("a"));
    }
    ...
    public void ofWithChineseTest() {
        ...
        Assert.equals("张三", builder.getQuery().get("a"));
        Assert.equals("李四", builder.getQuery().get("b"));
    ...
    public void ofSpecialTest() {
        ...
        Assert.equals("张三", builder.getQuery().get("a"));
        Assert.equals("%四", builder.getQuery().get("b"));
    ...
    public void weixinUrlTest() {
        ...
        // 原URL中的&amp;替换为&
        Assert.equals("https://mp.weixin.qq.com/s?" +
                        "__biz=MzI5NjkyNTIxMg==" +
                        "&mid=100000465&idx=1" +
                        "&sn=1044c0d19723f74f04f4c1da34eefa35" +
                        "&chksm=6cbda3a25bca2ab4516410db6ce6e125badaac2f8c5548ea6e18eab6dc3c5422cb8cbe1095f7",
    ...
    public void endWithSlashTest() {
        ...
        Assert.equals(getWorkDayUrl, builder.toString());
    }
    ...
    public void blankEncodeTest() {
        ...
        Assert.equals("http://a.com/aaa%20bbb.html", urlBuilder.toString());
    }
    ...
    public void dotEncodeTest() {
        ...
        Assert.equals("http://xtbgyy.digitalgd.com.cn/ebus/../../..", urlBuilder.toString());
    }
    ...
    public void multiSlashTest() {
        ...
        Assert.equals("https://hutool.cn//file/test.jpg", urlBuilder.toString());
    }
    ...
    public void toURITest() throws URISyntaxException {
        ...
        Assert.equals(new URI(webUrl), urlBuilder.toURI());
    }
    ...
    public void testEncodeInQuery() {
        ...
        final UrlBuilder urlBuilder = UrlBuilder.of(webUrl, StandardCharsets.UTF_8);
        Assert.equals("a=123&b=4?6&c=789", urlBuilder.getQueryStr());
    }
    ...
    public void encodePathTest() {
        ...
        Assert.equals(urlStr, urlBuilder.toString());
    }
    ...
    public void gimg2Test() {
        ...
        Assert.equals(url2, urlBuilder.toString());
    }
    ...
    public void fragmentEncodeTest() {
        ...
        Assert.equals("https://hutool.cn/docs/#/?id=%E7%AE%80%E4%BB%8B", urlBuilder.toString());

        urlBuilder = UrlBuilder.ofHttp(urlBuilder.toString());
        Assert.equals(urlBuilder.toString(), urlBuilder.toString());
    }
    ...
    public void slashEncodeTest() {
        ...
        Assert.equals(url, urlBuilder.toString());
    }
    ...
    public void addPathEncodeTest() {
        ...
        Assert.equals("https://domain.cn/api/xxx/bbb", url);
    }
    ...
    public void paramTest() {
        ...
        Assert.equals(url, builder.toString());
    }
    ...
    public void fragmentAppendParamTest() {
        ...
        Assert.equals("https://www.hutool.cn/#/a/b?timestamp=1640391380204", builder.toString());
    }
    ...
    public void issueI50NHQTest() {
        ...
        Assert.equals("http://127.0.0.1/devicerecord/list?start=2022-03-31%2000:00:00&end=2022-03-31%2023:59:59&page=1&limit=10", builder.toString());
    }
    ...
    public void issueI51T0VTest() {
        ...
        Assert.equals(url.replace("&amp;", "&"), of.toString());
    }
    ...
    public void issues2503Test() throws URISyntaxException {
        String duplicate = UrlBuilder.ofHttp("127.0.0.1:8080")
                ...
                .toURI()
                .toString();
        Assert.equals("http://127.0.0.1:8080?param%5B0%5D.field=%E7%BC%96%E7%A0%81", duplicate);
        ...
        String normal = UrlBuilder.ofHttp("127.0.0.1:8080")
                ...
                .toURI()
                .toString();
        Assert.equals(duplicate, normal);
    }
