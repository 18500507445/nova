...
public class UserAgentUtilTest {
    ...
    public void parseDesktopTest() {
        ...
        Assert.equals("Chrome", ua.getBrowser().toString());
        Assert.equals("14.0.835.163", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("535.1", ua.getEngineVersion());
        Assert.equals("Windows 7 or Windows Server 2008R2", ua.getOs().toString());
        Assert.equals("6.1", ua.getOsVersion());
        Assert.equals("Windows", ua.getPlatform().toString());
        Assert.isFalse(ua.isMobile());
    }
    ...
    public void parseMobileTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaStr);
        Assert.equals("Safari", ua.getBrowser().toString());
        Assert.equals("5.0.2", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("533.17.9", ua.getEngineVersion());
        Assert.equals("iPhone", ua.getOs().toString());
        Assert.equals("4_3_3", ua.getOsVersion());
        Assert.equals("iPhone", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseMiui10WithChromeTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaStr);
        Assert.equals("Chrome", ua.getBrowser().toString());
        Assert.equals("70.0.3538.80", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Android", ua.getOs().toString());
        Assert.equals("9", ua.getOsVersion());
        Assert.equals("Android", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseHuaweiPhoneWithNativeBrowserTest() {
        ...
        Assert.equals("Android Browser", ua.getBrowser().toString());
        Assert.equals("4.0", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Android", ua.getOs().toString());
        Assert.equals("10", ua.getOsVersion());
        Assert.equals("Android", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseSamsungPhoneWithNativeBrowserTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaString);
        Assert.equals("Android Browser", ua.getBrowser().toString());
        Assert.isNull(ua.getVersion());
        Assert.equals("Unknown", ua.getEngine().toString());
        Assert.isNull(ua.getEngineVersion());
        Assert.equals("Android", ua.getOs().toString());
        Assert.equals("9", ua.getOsVersion());
        Assert.equals("Android", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    ...
    public void parseWindows10WithChromeTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaStr);
        Assert.equals("Chrome", ua.getBrowser().toString());
        Assert.equals("70.0.3538.102", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Windows 10 or Windows Server 2016", ua.getOs().toString());
        Assert.equals("10.0", ua.getOsVersion());
        Assert.equals("Windows", ua.getPlatform().toString());
        Assert.isFalse(ua.isMobile());
    }
    ...
    public void parseWindows10WithIe11Test() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaStr);
        Assert.equals("MSIE11", ua.getBrowser().toString());
        Assert.equals("11.0", ua.getVersion());
        Assert.equals("Trident", ua.getEngine().toString());
        Assert.equals("7.0", ua.getEngineVersion());
        Assert.equals("Windows 10 or Windows Server 2016", ua.getOs().toString());
        Assert.equals("10.0", ua.getOsVersion());
        Assert.equals("Windows", ua.getPlatform().toString());
        Assert.isFalse(ua.isMobile());
    ...
    public void parseWindows10WithIeMobileLumia520Test() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaStr);
        Assert.equals("IEMobile", ua.getBrowser().toString());
        Assert.equals("11.0", ua.getVersion());
        Assert.equals("Trident", ua.getEngine().toString());
        Assert.equals("7.0", ua.getEngineVersion());
        Assert.equals("Windows Phone", ua.getOs().toString());
        Assert.equals("8.1", ua.getOsVersion());
        Assert.equals("Windows Phone", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseWindows10WithIe8EmulatorTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaStr);
        Assert.equals("MSIE", ua.getBrowser().toString());
        Assert.equals("8.0", ua.getVersion());
        Assert.equals("Trident", ua.getEngine().toString());
        Assert.equals("4.0", ua.getEngineVersion());
        Assert.equals("Windows 7 or Windows Server 2008R2", ua.getOs().toString());
        Assert.equals("6.1", ua.getOsVersion());
        Assert.equals("Windows", ua.getPlatform().toString());
        Assert.isFalse(ua.isMobile());
    ...
    public void parseWindows10WithEdgeTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaStr);
        Assert.equals("MSEdge", ua.getBrowser().toString());
        Assert.equals("18.17763", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Windows 10 or Windows Server 2016", ua.getOs().toString());
        Assert.equals("10.0", ua.getOsVersion());
    ...
    public void parseEdgeOnLumia950XLTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaStr);
        Assert.equals("MSEdge", ua.getBrowser().toString());
        Assert.equals("15.14900", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Windows Phone", ua.getOs().toString());
        Assert.equals("10.0", ua.getOsVersion());
    ...
    public void parseChromeOnWindowsServer2012R2Test() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaStr);
        Assert.equals("Chrome", ua.getBrowser().toString());
        Assert.equals("63.0.3239.132", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Windows 8.1 or Windows Server 2012R2", ua.getOs().toString());
        Assert.equals("6.3", ua.getOsVersion());
        Assert.equals("Windows", ua.getPlatform().toString());
        Assert.isFalse(ua.isMobile());
    }
    ...
    public void parseEdgeTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaStr);
        Assert.equals("MSEdge", ua.getBrowser().toString());
        Assert.equals("81.0.416.34", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Windows 10 or Windows Server 2016", ua.getOs().toString());
        Assert.equals("10.0", ua.getOsVersion());
    ...
    public void parseMicroMessengerTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaString);
        Assert.equals("MicroMessenger", ua.getBrowser().toString());
        Assert.equals("7.0.17", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("604.1.38", ua.getEngineVersion());
        Assert.equals("iPhone", ua.getOs().toString());
        Assert.equals("11_0", ua.getOsVersion());
        Assert.equals("iPhone", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseWorkWxTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaString);
        Assert.equals("wxwork", ua.getBrowser().toString());
        Assert.equals("3.0.31", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("605.1.15", ua.getEngineVersion());
        Assert.equals("iPhone", ua.getOs().toString());
        Assert.equals("iPhone", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseQQTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaString);
        Assert.equals("QQBrowser", ua.getBrowser().toString());
        Assert.equals("26", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("533.1", ua.getEngineVersion());
        Assert.equals("Android", ua.getOs().toString());
        Assert.equals("2.3.7", ua.getOsVersion());
        Assert.equals("Android", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseDingTalkTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaString);
        Assert.equals("DingTalk", ua.getBrowser().toString());
        Assert.equals("5.1.33", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("605.1.15", ua.getEngineVersion());
        Assert.equals("iPhone", ua.getOs().toString());
        Assert.equals("14_0", ua.getOsVersion());
        Assert.equals("iPhone", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseAlipayTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaString);
        Assert.equals("Alipay", ua.getBrowser().toString());
        Assert.equals("10.0.18.062203", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Android", ua.getOs().toString());
        Assert.equals("7.0", ua.getOsVersion());
        Assert.equals("Android", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseTaobaoTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaString);
        Assert.equals("Taobao", ua.getBrowser().toString());
        Assert.equals("4.9.2", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Android", ua.getOs().toString());
        Assert.equals("4.4.4", ua.getOsVersion());
        Assert.equals("Android", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseUCTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaString);
        Assert.equals("UCBrowser", ua.getBrowser().toString());
        Assert.equals("4.0.3214.0", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Windows 7 or Windows Server 2008R2", ua.getOs().toString());
        Assert.equals("6.1", ua.getOsVersion());
    ...
    public void parseUCTest2() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaString);
        Assert.equals("UCBrowser", ua.getBrowser().toString());
        Assert.equals("12.7.6.1251", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.51.1", ua.getEngineVersion());
        Assert.equals("iPhone", ua.getOs().toString());
        Assert.equals("12_4_1", ua.getOsVersion());
        Assert.equals("iPhone", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseQuarkTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaString);
        Assert.equals("Quark", ua.getBrowser().toString());
        Assert.equals("3.6.2.993", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("601.1.46", ua.getEngineVersion());
        Assert.equals("iPhone", ua.getOs().toString());
        Assert.equals("12_4_1", ua.getOsVersion());
        Assert.equals("iPhone", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    ...
    public void parseWxworkTest() {
        ...
        UserAgent ua = UserAgentUtil.parse(uaString);
        Assert.equals("wxwork", ua.getBrowser().toString());
        Assert.equals("3.1.10", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Windows 10 or Windows Server 2016", ua.getOs().toString());
        Assert.equals("10.0", ua.getOsVersion());
    ...
    public void parseEdgATest() {
        ...
        Assert.equals("MSEdge", ua.getBrowser().toString());
        Assert.equals("96.0.1054.36", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Android", ua.getOs().toString());
        Assert.equals("11", ua.getOsVersion());
        Assert.equals("Android", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    }
    ...
    public void parseLenovoTest() {
        ...
        Assert.equals("Lenovo", ua.getBrowser().toString());
        Assert.equals("7.0.0.6241", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("537.36", ua.getEngineVersion());
        Assert.equals("Windows 10 or Windows Server 2016", ua.getOs().toString());
        Assert.equals("10.0", ua.getOsVersion());
    ...
    public void parseXiaoMiTest() {
        ...
        Assert.equals("MiuiBrowser", ua.getBrowser().toString());
        Assert.equals("16.0.18", ua.getVersion());
        Assert.equals("Webkit", ua.getEngine().toString());
        Assert.equals("534.24", ua.getEngineVersion());
        Assert.equals("Android", ua.getOs().toString());
        Assert.equals("11", ua.getOsVersion());
        Assert.equals("Android", ua.getPlatform().toString());
        Assert.isTrue(ua.isMobile());
    ...
    public void parseFromDeepinTest() {
        ...
        final UserAgent ua = UserAgentUtil.parse(uaStr);
        Assert.equals("Linux", ua.getOs().toString());
    }
}
