...
public class MirrorLinkAnnotationPostProcessorTest {
    ...
    public void processTest() {
        ...
        Assert.isTrue(valueAttribute.isWrapped());
        Assert.equals(MirroredAnnotationAttribute.class, valueAttribute.getClass());
        ...
        Assert.equals(MirroredAnnotationAttribute.class, nameAttribute.getClass());

        Assert.equals(((WrappedAnnotationAttribute) nameAttribute).getLinked(), ((WrappedAnnotationAttribute) valueAttribute).getOriginal());
        Assert.equals(((WrappedAnnotationAttribute) nameAttribute).getOriginal(), ((WrappedAnnotationAttribute) valueAttribute).getLinked());
    }
