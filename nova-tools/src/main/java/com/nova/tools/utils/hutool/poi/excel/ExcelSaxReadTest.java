...
//			Console.log("[{}] [{}] {}", sheetIndex, rowIndex, rowlist);
            if (5 != rowIndex && 6 != rowIndex) {
                // 测试样例中除第五行、第六行都为非空行
                Assert.isTrue(CollUtil.isNotEmpty(rowlist));
            }
        };
    }
    ...
    public void formulaRead07Test() {
        ...
        Assert.equals(50L, value.getResult());
    }
    ...
    public void dateReadXlsTest() {
        ...
        Assert.equals("2020-10-09 00:00:00", rows.get(1));
        // 非日期格式不做转换
        Assert.equals("112233", rows.get(2));
        Assert.equals("1000.0", rows.get(3));
        Assert.equals("2012-12-21 00:00:00", rows.get(4));
    }
