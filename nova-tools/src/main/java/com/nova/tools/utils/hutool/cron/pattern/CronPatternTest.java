...
public class CronPatternTest {
    ...
    public void CronPatternTest2() {
        ...
        Assert.isTrue(pattern.match(DateUtil.parse("2018-10-09 12:00:00").getTime(), false));
        Assert.isTrue(pattern.match(DateUtil.parse("2018-10-09 12:30:00").getTime(), false));

        pattern = CronPattern.of("32 * * * *");
        Assert.isTrue(pattern.match(DateUtil.parse("2018-10-09 12:32:00").getTime(), false));
    }
    ...
    private void assertMatch(CronPattern pattern, String date) {
        Assert.isTrue(pattern.match(DateUtil.parse(date).toCalendar(), false));
        Assert.isTrue(pattern.match(DateUtil.parse(date).toCalendar(), true));
    }
}
