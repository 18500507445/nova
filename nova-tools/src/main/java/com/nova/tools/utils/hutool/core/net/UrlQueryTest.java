...
public class UrlQueryTest {
    ...
    public void parseTest() {
        ...
        Assert.equals("111==", parse.get("b"));
        Assert.equals("a=1&b=111==", parse.toString());
    }
    ...
    public void ofHttpWithoutEncodeTest() {
        ...
        Assert.equals("imageMogr2/auto-orient/thumbnail/500&pid=259848", queryStr);
    }
    ...
    public void parseTest2() {
        ...
        Assert.equals("=d52i5837i4ed=o39-ap9e19s5--=72e54*ll0lodl-f338868d2", parse.toString());
    }
    ...
    public void parseTest3() {
        ...
        Assert.isTrue(MapUtil.isEmpty(query.getQueryMap()));
    }
    ...
    public void parseTest4() {
        ...
        Assert.equals(queryStr, query.toString());
    }
    ...
    public void buildWithMapTest() {
        ...
        Assert.equals("username=SSM&password=123456", query);

        map = new TreeMap<>();
        map.put("username", "SSM");
        map.put("password", "123456");
        query = URLUtil.buildQuery(map, StandardCharsets.UTF_8);
        Assert.equals("password=123456&username=SSM", query);
    }
    ...
    public void buildHasNullTest() {
        ...
        map.put("password", "123456");
        String query = URLUtil.buildQuery(map, StandardCharsets.UTF_8);
        Assert.equals("password=123456", query);

        map = new TreeMap<>();
        map.put("username", "SSM");
        map.put("password", "");
        query = URLUtil.buildQuery(map, StandardCharsets.UTF_8);
        Assert.equals("password=&username=SSM", query);
    ...
    public void buildSpecialTest() {
        ...
        map.put("key2", "123456&");
        String query = URLUtil.buildQuery(map, StandardCharsets.UTF_8);
        Assert.equals("key1%26=SSM&key2=123456%26", query);

        map = new TreeMap<>();
        map.put("username=", "SSM");
        map.put("password", "=");
        query = URLUtil.buildQuery(map, StandardCharsets.UTF_8);
        Assert.equals("password==&username%3D=SSM", query);
    }
