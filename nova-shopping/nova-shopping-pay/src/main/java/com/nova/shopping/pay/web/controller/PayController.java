...
import com.nova.shopping.pay.service.strategy.PayStrategy;
...
public class PayController extends BaseController {
    ...
    public AjaxResult list(PayParam param) {
        ...
        if (ObjectUtil.isNotNull(o)) {
            ...
            PayList query = PayList.builder().source(source).sid(sid).build();
            List<PayList> payList = payListService.selectMyPayListList(query);
            if (CollUtil.isNotEmpty(payList)) {
                for (PayList data : payList) {
