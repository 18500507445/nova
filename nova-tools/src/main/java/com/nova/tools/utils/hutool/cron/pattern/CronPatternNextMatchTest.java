...
public class CronPatternNextMatchTest {
    ...
    public void nextMatchAllAfterTest() {
        ...
        Assert.equals(date.getTime(), DateUtil.date(calendar).getTime());
        ...
        Assert.equals(DateUtil.parse("2022-04-08 07:45:00"), DateUtil.date(calendar));
        ...
        //noinspection ConstantConditions
        calendar = pattern.nextMatchAfter(date.toCalendar());
        Assert.equals(DateUtil.parse("2022-04-08 08:00:00"), DateUtil.date(calendar));
        ...
        //noinspection ConstantConditions
        calendar = pattern.nextMatchAfter(date.toCalendar());
        Assert.equals(DateUtil.parse("2022-04-09 00:00:00"), DateUtil.date(calendar));
        ...
        //noinspection ConstantConditions
        calendar = pattern.nextMatchAfter(date.toCalendar());
        Assert.equals(DateUtil.parse("2022-05-01 00:00:00"), DateUtil.date(calendar));
    }
    ...
    public void nextMatchAfterTest() {
        ...
        Assert.isTrue(pattern.match(calendar, true));
        Assert.equals("2022-04-12 09:12:23", DateUtil.date(calendar).toString());
        ...
        Assert.isTrue(pattern.match(calendar, true));
        Assert.equals("2022-04-12 10:12:23", DateUtil.date(calendar).toString());
        ...
        Assert.isTrue(pattern.match(calendar, true));
        Assert.equals("2022-05-12 00:12:23", DateUtil.date(calendar).toString());
        ...
        Assert.isTrue(pattern.match(calendar, true));
        Assert.equals("2022-01-12 00:12:23", DateUtil.date(calendar).toString());
    }
    ...
    public void nextMatchAfterByWeekTest() {
        ...
        Assert.equals("2022-04-09 01:01:01", DateUtil.date(calendar).toString());
    }
}
