...
public class HmacTest {
    ...
    public void hmacTest() {
        ...
        Assert.equals("b977f4b13f93f549e06140971bded384", macHex1);

        String macHex2 = mac.digestHex(IoUtil.toStream(testStr, CharsetUtil.CHARSET_UTF_8));
        Assert.equals("b977f4b13f93f549e06140971bded384", macHex2);
    }
    ...
    public void hmacSha1Test() {
        ...
        String testStr = "test中文";
        String macHex1 = mac.digestHex(testStr);
        Assert.equals("1dd68d2f119d5640f0d416e99d3f42408b88d511", macHex1);

        String macHex2 = mac.digestHex(IoUtil.toStream(testStr, CharsetUtil.CHARSET_UTF_8));
        Assert.equals("1dd68d2f119d5640f0d416e99d3f42408b88d511", macHex2);
    }
    ...
    public void zuc128MacTest() {
        ...
        String testStr = "test中文";
        String macHex1 = mac.digestHex(testStr);
        Assert.equals("1e0b9455", macHex1);
    }
    ...
    public void zuc256MacTest() {
        ...
        String testStr = "test中文";
        String macHex1 = mac.digestHex(testStr);
        Assert.equals("d9ad618357c1bfb1d9d1200a763d5eaa", macHex1);
    }
    ...
    public void sm4CMACTest() {
        ...
        String macHex1 = mac.digestHex(testStr);
        Assert.equals("58a0d231315664af51b858a174eabc21", macHex1);
    }
}
