...
public class ListUtilTest {
	...
	public void splitTest() {
		...
		Assert.equals(ListUtil.empty(), lists);

		lists = ListUtil.split(Arrays.asList(1, 2, 3, 4), 1);
		Assert.equals("[[1], [2], [3], [4]]", lists.toString());
	...
	public void splitBenchTest() {
		...
		Assert.equals(CollSplitResult, ListSplitResult);
	...
	public void splitAvgTest() {
		...
		Assert.equals("[[1, 2], [3]]", lists.toString());
	}
	...
	public void editTest() {
		...
		Assert.equals("edit1", filter.get(0));
		Assert.equals("edit2", filter.get(1));
		Assert.equals("edit3", filter.get(2));
	}
	...
	public void indexOfAll() {
		...
		Assert.equals(new int[]{1,5}, indexArray);
		final int[] indexArray2 = ListUtil.indexOfAll(a, "1"::equals);
		Assert.equals(new int[]{0,6}, indexArray2);
	}
	...
	public void pageTest() {
		...
		Assert.equals(new int[]{1,2},a_1);
		Assert.equals(new int[]{1,2},a1);
		Assert.equals(new int[]{3,4},a2);
		Assert.equals(new int[]{5},a3);
		Assert.equals(new int[]{},a4);
		...
		Assert.equals(new int[]{1,2},b_1);
		Assert.equals(new int[]{1,2},b1);
		Assert.equals(new int[]{3,4},b2);
		Assert.equals(new int[]{5},b3);
		Assert.equals(new int[]{},b4);
		...
		Assert.equals(new int[]{1,2},c_1);
		Assert.equals(new int[]{1,2},c1);
		Assert.equals(new int[]{3,4},c2);
		Assert.equals(new int[]{5},c3);
		Assert.equals(new int[]{},c4);


		PageUtil.setFirstPageNo(1);
		final int[] d1 = ListUtil.page(0,8,a).stream().mapToInt(Integer::valueOf).toArray();
		Assert.equals(new int[]{1,2,3,4,5},d1);

		// page with consumer
		final List<List<Integer>> pageListData = new ArrayList<>();
		ListUtil.page(a, 2, pageListData::add);
		Assert.equals(new int[]{1, 2}, pageListData.get(0).stream().mapToInt(Integer::valueOf).toArray());
		Assert.equals(new int[]{3, 4}, pageListData.get(1).stream().mapToInt(Integer::valueOf).toArray());
		Assert.equals(new int[]{5}, pageListData.get(2).stream().mapToInt(Integer::valueOf).toArray());
		...
		Assert.equals(new int[]{}, pageListData.get(0).stream().mapToInt(Integer::valueOf).toArray());
		Assert.equals(new int[]{3, 4}, pageListData.get(1).stream().mapToInt(Integer::valueOf).toArray());
		Assert.equals(new int[]{5}, pageListData.get(2).stream().mapToInt(Integer::valueOf).toArray());
	...
	public void subTest() {
		...
		// 对子列表操作不影响原列表
		Assert.equals(4, of.size());
		Assert.equals(1, sub.size());
	}
	...
	public void sortByPropertyTest() {
		...
		Assert.equals("test1", order.get(0).getName());
		Assert.equals("test2", order.get(1).getName());
		Assert.equals("test3", order.get(2).getName());
		Assert.equals("test4", order.get(3).getName());
		Assert.equals("test5", order.get(4).getName());
	}
	...
	public void swapIndex() {
		...
		Assert.equals(8, (int) list.get(1));
	}
	...
	public void setOrPaddingNullTest(){
		...
		Assert.equals("[a]", list.toString());

		//append值
		ListUtil.setOrPadding(list, 1, "a");
		Assert.equals("[a, a]", list.toString());
