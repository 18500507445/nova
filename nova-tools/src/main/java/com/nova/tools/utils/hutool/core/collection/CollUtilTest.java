...
public class CollUtilTest {
    ...
    public void testPredicateContains() {
        ...
        Assert.isTrue(CollUtil.contains(list, s -> s.startsWith("a")));
        Assert.isFalse(CollUtil.contains(list, s -> s.startsWith("d")));
    }
    ...
    public void testRemoveWithAddIf() {
        ...
        Assert.equals(list, exceptRemovedList);
        Assert.equals(resultList, exceptResultList);
    ...
    public void testPadLeft() {
        ...
        Assert.equals(srcList, answerList);
    ...
    public void isNotEmptyTest() {
        Assert.isFalse(CollUtil.isNotEmpty((Collection<?>) null));
    }
    ...
    public void valuesOfKeysTest() {
        ...
        Assert.isTrue(v1s.contains(12));
        Assert.isTrue(v1s.contains(23));
        Assert.isTrue(v1s.contains("张三"));

        final ArrayList<Object> v2s = CollUtil.valuesOfKeys(v2, keys);
        Assert.isTrue(v2s.contains(15));
        Assert.isTrue(v2s.contains(13));
        Assert.isTrue(v2s.contains("李四"));
    }
    ...
    public void unionTest() {
        ...
        Assert.equals(3, CollUtil.count(union, "b"::equals));
    }
    ...
    public void intersectionTest() {
        ...
        Assert.equals(2, CollUtil.count(intersection, "b"::equals));
    }
    ...
    public void intersectionDistinctTest() {
        ...
        Assert.equals(CollUtil.newLinkedHashSet("a", "b", "c", "d"), intersectionDistinct);

        final Collection<String> intersectionDistinct2 = CollUtil.intersectionDistinct(list1, list2, list3);
        Assert.isTrue(intersectionDistinct2.isEmpty());
    }
    ...
    public void disjunctionTest() {
        ...
        Assert.isTrue(disjunction.contains("b"));
        Assert.isTrue(disjunction.contains("x2"));
        Assert.isTrue(disjunction.contains("x"));

        final Collection<String> disjunction2 = CollUtil.disjunction(list2, list1);
        Assert.isTrue(disjunction2.contains("b"));
        Assert.isTrue(disjunction2.contains("x2"));
        Assert.isTrue(disjunction2.contains("x"));
    }
    ...
    public void disjunctionTest2() {
        ...
        final Collection<String> disjunction = CollUtil.disjunction(list1, list2);
        Assert.equals(list2, disjunction);
        final Collection<String> disjunction2 = CollUtil.disjunction(list2, list1);
        Assert.equals(list2, disjunction2);
    }
    ...
    public void disjunctionTest3() {
        ...
        final Collection<String> disjunction = CollUtil.disjunction(list1, list2);
        Assert.isTrue(disjunction.contains("1"));
        Assert.isTrue(disjunction.contains("2"));
        Assert.isTrue(disjunction.contains("3"));
        Assert.isTrue(disjunction.contains("a"));
        Assert.isTrue(disjunction.contains("b"));
        Assert.isTrue(disjunction.contains("c"));
        final Collection<String> disjunction2 = CollUtil.disjunction(list2, list1);
        Assert.isTrue(disjunction2.contains("1"));
        Assert.isTrue(disjunction2.contains("2"));
        Assert.isTrue(disjunction2.contains("3"));
        Assert.isTrue(disjunction2.contains("a"));
        Assert.isTrue(disjunction2.contains("b"));
        Assert.isTrue(disjunction2.contains("c"));
    }
    ...
    public void subtractTest() {
        ...
        Assert.equals(1, subtract.size());
        Assert.equals("x", subtract.iterator().next());
    }
    ...
    public void toMapListAndToListMapTest() {
        ...
        Assert.equals("值1", map.get("a").get(0));
        Assert.equals("值2", map.get("a").get(1));

        // ----------------------------------------------------------------------------------------
        final List<Map<String, String>> listMap = CollUtil.toMapList(map);
        Assert.equals("值1", listMap.get(0).get("a"));
        Assert.equals("值2", listMap.get(1).get("a"));
    }
    ...
    public void getFieldValuesTest() {
        ...
        Assert.equals("张三", fieldValues.get(0));
        Assert.equals("李四", fieldValues.get(1));
    }
    ...
    public void splitTest() {
        ...
        Assert.equals(3, split.get(0).size());
    }
    ...
    public void filterTest() {
        ...
        Assert.equals(CollUtil.newArrayList("a1", "b1", "c1"), filtered);
    }
    ...
    public void filterTest2() {
        ...
        // 原地过滤
        Assert.equals(list, filtered);
        Assert.equals(CollUtil.newArrayList("b", "c"), filtered);
    }
    ...
    public void filterSetTest() {
        ...
        Assert.equals(CollUtil.newLinkedHashSet("a", "b", "c"), filtered);
    }
    ...
    public void filterRemoveTest() {
        ...
        Assert.equals(1, removed.size());
        Assert.equals("a", removed.get(0));
    ...
    public void removeNullTest() {
        ...
        // 原地过滤
        Assert.equals(list, filtered);
        Assert.equals(CollUtil.newArrayList("a", "b", "c", "", "  "), filtered);
    }
    ...
    public void groupTest() {
        ...
        Assert.equals(CollUtil.newArrayList("2", "4", "6"), group2.get(0));
        Assert.equals(CollUtil.newArrayList("1", "3", "5"), group2.get(1));
    }
    ...
    public void groupByFieldTest() {
        ...
        Assert.equals("张三", groupByField.get(0).get(0).getName());
        Assert.equals("王五", groupByField.get(0).get(1).getName());

        Assert.equals("李四", groupByField.get(1).get(0).getName());
    }
    ...
    public void sortByPropertyTest() {
        ...
        Assert.equals("李四", list.get(0).getName());
        Assert.equals("王五", list.get(1).getName());
        Assert.equals("张三", list.get(2).getName());
    }
    ...
    public void sortByPropertyTest2() {
        ...
        Assert.equals("李四", list.get(0).getName());
        Assert.equals("张三", list.get(1).getName());
        Assert.equals("王五", list.get(2).getName());
    }
    ...
    public void fieldValueMapTest() {
        ...
        Assert.equals("李四", map.get("李四").getName());
        Assert.equals("王五", map.get("王五").getName());
        Assert.equals("张三", map.get("张三").getName());
    }
    ...
    public void fieldValueAsMapTest() {
        ...
        Assert.equals(new Integer(12), map.get("张三"));
        Assert.equals(new Integer(13), map.get("李四"));
        Assert.equals(new Integer(14), map.get("王五"));
    }

    @Test
    public void emptyTest() {
        final SortedSet<String> emptySortedSet = CollUtil.empty(SortedSet.class);
        Assert.equals(Collections.emptySortedSet(), emptySortedSet);

        final Set<String> emptySet = CollUtil.empty(Set.class);
        Assert.equals(Collections.emptySet(), emptySet);

        final List<String> emptyList = CollUtil.empty(List.class);
        Assert.equals(Collections.emptyList(), emptyList);
    }
    ...
    public void listTest() {
        ...
        Assert.isTrue(list1 instanceof ArrayList);
        Assert.isTrue(list2 instanceof LinkedList);
    }
    ...
    public void listTest2() {
        ...
        Assert.equals("[a, b, c]", list1.toString());
        Assert.equals("[a, b, c]", list2.toString());
    }
    ...
    public void addAllIfNotContainsTest() {
        ...
        Assert.equals(3, list1.size());
        Assert.equals("1", list1.get(0));
        Assert.equals("2", list1.get(1));
        Assert.equals("3", list1.get(2));
    }
    ...
    public void subInput1PositiveNegativePositiveOutput1() {
        ...
        arrayList.add(null);
        Assert.equals(arrayList, retval);
    }
    ...
    public void sortPageAllTest() {
        ...
        Assert.equals(CollUtil.newArrayList(4, 3, 2, 1), sortPageAll);
    }
    ...
    public void containsAnyTest() {
        ...
        Assert.isTrue(CollUtil.containsAny(list1, list2));
    }
    ...
    public void zipTest() {
        ...
        Assert.equals(4, Objects.requireNonNull(map).size());

        Assert.equals(1, map.get("a").intValue());
        Assert.equals(2, map.get("b").intValue());
        Assert.equals(3, map.get("c").intValue());
        Assert.equals(4, map.get("d").intValue());
    }
    ...
    public void toMapTest() {
        ...
        Assert.equals("a", map.get("keya"));
        Assert.equals("b", map.get("keyb"));
        Assert.equals("c", map.get("keyc"));
        Assert.equals("d", map.get("keyd"));
    }

    @Test
    public void addIfAbsentTest() {
        // 为false的情况
        Assert.isFalse(CollUtil.addIfAbsent(null, null));
        Assert.isFalse(CollUtil.addIfAbsent(CollUtil.newArrayList(), null));
        Assert.isFalse(CollUtil.addIfAbsent(null, "123"));
        Assert.isFalse(CollUtil.addIfAbsent(CollUtil.newArrayList("123"), "123"));
        Assert.isFalse(CollUtil.addIfAbsent(CollUtil.newArrayList(new Animal("jack", 20)),
                new Animal("jack", 20)));

        // 正常情况
        Assert.isTrue(CollUtil.addIfAbsent(CollUtil.newArrayList("456"), "123"));
        Assert.isTrue(CollUtil.addIfAbsent(CollUtil.newArrayList(new Animal("jack", 20)),
                new Dog("jack", 20)));
        Assert.isTrue(CollUtil.addIfAbsent(CollUtil.newArrayList(new Animal("jack", 20)),
                new Animal("tom", 20)));
    }
    ...
    public void mapToMapTest() {
        ...
        Assert.equals(1L, (long) map.get("a"));
        Assert.equals(12L, (long) map.get("b"));
        Assert.equals(134L, (long) map.get("c"));
    }
    ...
    public void countMapTest() {
        ...
        Assert.equals(Integer.valueOf(2), countMap.get("a"));
        Assert.equals(Integer.valueOf(2), countMap.get("b"));
        Assert.equals(Integer.valueOf(2), countMap.get("c"));
        Assert.equals(Integer.valueOf(1), countMap.get("d"));
    }
    ...
    public void pageTest() {
        ...
        Assert.equals(0, CollUtil.page(3, 5, objects).size());
    }
    ...
    public void subtractToListTest() {
        ...
        Assert.equals(1L, (long) result.get(0));
    }
    ...
    public void sortComparableTest() {
        ...
        Assert.equals("a,b,c", CollUtil.join(sort, ","));
    }
    ...
    public void setValueByMapTest() {
        ...
        Assert.equals(people.get(1).getGender(), "woman");
        CollUtil.setValueByMap(people, genderMap, Person::getId, Person::setGender);
        Assert.equals(people.get(1).getGender(), "妇女");
        ...
        Assert.equals(people.get(1).getGender(), "小孩");
    }

    @Test
    public void distinctTest() {
        final ArrayList<Integer> distinct = CollUtil.distinct(ListUtil.of(5, 3, 10, 9, 0, 5, 10, 9));
        Assert.equals(ListUtil.of(5, 3, 10, 9, 0), distinct);
    }
    ...
    public void distinctByFunctionTest() {
        ...
        Assert.equals(2, distinct.size());
        Assert.equals("ff", distinct.get(0).getName());
        Assert.equals("ee", distinct.get(1).getName());

        // 非覆盖模式下，保留了最早加入的aa和bb
        distinct = CollUtil.distinct(people, Person::getGender, false);
        Assert.equals(2, distinct.size());
        Assert.equals("aa", distinct.get(0).getName());
        Assert.equals("bb", distinct.get(1).getName());
    }
