...
public class RSATest {
	...
	public void rsaCustomKeyTest() {
		...
		Assert.equals("我是一段测试aaaa", StrUtil.str(decrypt2, CharsetUtil.CHARSET_UTF_8));
	}
	...
	public void rsaTest() {
		...
		// 获取私钥和公钥
		Assert.notNull(rsa.getPrivateKey());
		Assert.notNull(rsa.getPrivateKeyBase64());
		Assert.notNull(rsa.getPublicKey());
		Assert.notNull(rsa.getPrivateKeyBase64());
	...
	public void rsaBase64Test() {
		...
		Assert.equals(text.toString(), decrypt2);
	}
	...
	public void rsaDecodeTest() {
		...
		Assert.equals("虎头闯杭州,多抬头看天,切勿只管种地", StrUtil.str(decrypt, CharsetUtil.CHARSET_UTF_8));
	}
