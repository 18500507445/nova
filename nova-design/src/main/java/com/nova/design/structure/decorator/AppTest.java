package com.nova.design.structure.decorator;

import com.nova.design.structure.decorator.coupon.DiscountCouponCalDecorator;
import com.nova.design.structure.decorator.coupon.FullDiscountCouponCalDecorator;
import com.nova.design.structure.decorator.coupon.OrderCal;
import com.nova.design.structure.decorator.coupon.model.Product;
import com.nova.design.structure.decorator.people.BikeDecorator;
import com.nova.design.structure.decorator.people.CarDecorator;
import com.nova.design.structure.decorator.people.Person;
import com.nova.design.structure.decorator.people.SimplePerson;
