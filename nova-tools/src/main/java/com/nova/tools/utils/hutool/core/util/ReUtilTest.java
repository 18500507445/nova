...
public class ReUtilTest {
    ...
    public void extractMultiTest2() {
        ...
        Assert.equals("Z-Z-Z-a-a-a-b-b-b-c", resultExtractMulti);
    }
    ...
    public void delFirstTest() {
        ...
        Assert.equals("ZZbbbccc中文1234", resultDelFirst);
    }
    ...
    public void delLastTest() {
        ...
        //空字符串兼容
        Assert.equals(blank, ReUtil.delLast("\\d+", blank));
        Assert.equals(blank, ReUtil.delLast(PatternPool.NUMBERS, blank));

        //去除数字
        Assert.equals("公斤", ReUtil.delLast("\\d+", word));
        Assert.equals("公斤", ReUtil.delLast(PatternPool.NUMBERS, word));
        //去除汉字
        Assert.equals("180", ReUtil.delLast("[\u4E00-\u9FFF]+", word));
        Assert.equals("180", ReUtil.delLast(PatternPool.CHINESES, word));

        //多个匹配删除最后一个 判断是否不在包含最后的数字
        String s = ReUtil.delLast("\\d+", sentence);
        Assert.equals("10.商品KLS100021型号xxl适合身高180体重斤的用户", s);
        s = ReUtil.delLast(PatternPool.NUMBERS, sentence);
        Assert.equals("10.商品KLS100021型号xxl适合身高180体重斤的用户", s);

        //多个匹配删除最后一个 判断是否不在包含最后的数字
        Assert.isFalse(ReUtil.delLast("[\u4E00-\u9FFF]+", sentence).contains("斤的用户"));
        Assert.isFalse(ReUtil.delLast(PatternPool.CHINESES, sentence).contains("斤的用户"));
    }
    ...
    public void delAllTest() {
        ...
        Assert.equals("发东方大厦eee好机会eee好机会", resultDelAll);
    }
    ...
    public void findAllTest() {
        ...
        Assert.equals(expected, resultFindAll);
    }
    ...
    public void getFirstNumberTest() {
        ...
        Assert.equals(Integer.valueOf(1234), resultGetFirstNumber);
    }
    ...
    public void replaceAllTest() {
        ...
        Assert.equals("ZZZaaabbbccc中文->1234<-", replaceAll);
    }
    ...
    public void getAllGroupsTest() {
        ...
        Assert.equals("192-168-1", allGroups.get(0));
        Assert.equals("192", allGroups.get(1));
        Assert.equals("168", allGroups.get(2));
        Assert.equals("1", allGroups.get(3));

        allGroups = ReUtil.getAllGroups(pattern, "192-168-1-1", false);
        Assert.equals("192", allGroups.get(0));
        Assert.equals("168", allGroups.get(1));
        Assert.equals("1", allGroups.get(2));
    }
    ...
    public void getAllGroupNamesTest() {
        ...
        Assert.equals(map.get("year"), "2021");
        Assert.equals(map.get("month"), "10");
        Assert.equals(map.get("day"), "11");
    }
