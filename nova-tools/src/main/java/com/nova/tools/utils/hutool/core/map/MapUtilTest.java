...
public class MapUtilTest {
    ...
    public void filterTest() {
        ...
        Assert.equals(2, map2.size());

        Assert.equals("2", map2.get("b"));
        Assert.equals("4", map2.get("d"));
    }
    ...
    public void mapTest() {
        ...
        Assert.equals("lovely girl", resultMap.get(0));
        Assert.equals("friendly boy", resultMap.get(1));
        Assert.equals("happily child", resultMap.get(2));
        ...
        groups.forEach(group -> {
            ...
            Assert.equals("刑部尚书手工耿", users.get(0).getName());
            Assert.equals("木瓜大盗大漠叔", users.get(1).getName());
            Assert.equals("竹鼠发烧找华农", users.get(2).getName());
            Assert.equals("朴实无华朱一旦", users.get(3).getName());
        });
        // 对null友好
        MapUtil.map(MapUtil.of(0, 0), (k, v) -> null).forEach((k, v) -> Assert.isNull(v));
    }
    ...
    public void filterContainsTest() {
        ...
        Assert.equals(2, map2.size());
        Assert.equals("1", map2.get("abc"));
        Assert.equals("2", map2.get("bcd"));
    }
    ...
    public void editTest() {
        ...
        Assert.equals(4, map2.size());

        Assert.equals("10", map2.get("a"));
        Assert.equals("20", map2.get("b"));
        Assert.equals("30", map2.get("c"));
        Assert.equals("40", map2.get("d"));
    }
    ...
    public void reverseTest() {
        ...
        Assert.equals("a", map2.get("1"));
        Assert.equals("b", map2.get("2"));
        Assert.equals("c", map2.get("3"));
        Assert.equals("d", map2.get("4"));
    }
    ...
    public void toObjectArrayTest() {
        ...
        Assert.equals("a", objectArray[0][0]);
        Assert.equals("1", objectArray[0][1]);
        Assert.equals("b", objectArray[1][0]);
        Assert.equals("2", objectArray[1][1]);
        Assert.equals("c", objectArray[2][0]);
        Assert.equals("3", objectArray[2][1]);
        Assert.equals("d", objectArray[3][0]);
        Assert.equals("4", objectArray[3][1]);
    }
    ...
    public void sortJoinTest() {
        ...
        Assert.equals("key1value1key2value2key3value3", join1);

        String join2 = MapUtil.sortJoin(build, StrUtil.EMPTY, StrUtil.EMPTY, false, "123");
        Assert.equals("key1value1key2value2key3value3123", join2);

        String join3 = MapUtil.sortJoin(build, StrUtil.EMPTY, StrUtil.EMPTY, false, "123", "abc");
        Assert.equals("key1value1key2value2key3value3123abc", join3);
    }
    ...
    public void ofEntriesTest() {
        ...
        Assert.equals(Integer.valueOf(1), map.get("a"));
        Assert.equals(Integer.valueOf(2), map.get("b"));
    }
