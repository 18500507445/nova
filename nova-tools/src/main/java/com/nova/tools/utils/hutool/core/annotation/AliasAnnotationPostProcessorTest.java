...
public class AliasAnnotationPostProcessorTest {
    ...
    public void processTest() {
        ...
        Assert.equals(ForceAliasedAnnotationAttribute.class, valueAttribute.getClass());
        ...
        Assert.isFalse(nameAttribute.isWrapped());
        Assert.equals(CacheableAnnotationAttribute.class, nameAttribute.getClass());

        Assert.equals(nameAttribute, ((WrappedAnnotationAttribute) valueAttribute).getLinked());
    }
